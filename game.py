...
class Game:
    ...
    def reset_game(self, mode: str = "pvp"):
        ...
        # Posições baseadas no tamanho da tela
        ...
        if mode == "pvp":
            ...
            self.create_entity(
                class_p1, p1_x, center_y, (255, 100, 100), 
            ...
            self.create_entity(
                class_p2, p2_x, center_y, (100, 100, 255),
            ...
            player = self.create_entity(
                class_p1, p1_x, center_y, (100, 200, 100),
                p1_controller, weapon_p1
            )
            ...
            ai = self.create_entity(
                class_p2, p2_x, center_y, (255, 100, 100),
            ...
            ai1 = self.create_entity(
                class_p1, p1_x, center_y, (100, 200, 255),
            ...
            ai2 = self.create_entity(
                class_p2, p2_x, center_y, (255, 200, 100),
    ...
    def draw_map_selection(self):
        ...
        preview_height = int(SCREEN_HEIGHT * 0.4)
        ...
        dots_y = preview_y + preview_height + 100
        dot_spacing = 20
    ...
    def draw_game(self):
        ...
        # PvE: jogador vs IA, ai_vs_ai: IA vs IA
